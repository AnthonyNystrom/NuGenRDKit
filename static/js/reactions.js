/**
 * reactions.js — page module for "/reactions".
 *
 * Phase-5 mechanical extraction of the inline <script> that previously
 * lived in templates/reactions.html. Logic preserved verbatim except that
...
(function () {
  "use strict";
  if (window.location.pathname !== "/reactions") return;

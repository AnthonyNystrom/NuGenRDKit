/**
 * visualization.js — page module for "/visualization".
 *
 * Phase-5 mechanical extraction of the inline <script> that previously
 * lived in templates/visualization.html. Logic preserved verbatim except that
...
(function () {
  "use strict";
  if (window.location.pathname !== "/visualization") return;
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex space-x-2">
                                    <button data-action="reset3DView" class="text-sm px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white border border-gray-200 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex space-x-2">
                                    <button data-action="resetSurfaceView" class="text-sm px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors">
                                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                                        Reset
                                    </button>
                                </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white border border-gray-200 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex space-x-2">
                                    <button data-action="resetPharmacophoreView" class="text-sm px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors">
                                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                                        Reset
                                    </button>
                                </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white border border-gray-200 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex space-x-2">
                                    <button data-action="resetScaffoldView" class="text-sm px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors">
                                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                                        Reset
                                    </button>
                                </div>
        ...
        <div class="w-full h-full bg-black flex flex-col">
            <div class="flex items-center justify-between p-4 bg-gray-900 text-white">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button data-action="reset3DView" class="px-3 py-1 bg-gray-800 text-white rounded text-sm border border-gray-600 hover:bg-gray-700 transition-colors">
                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                        Reset
                    </button>
                </div>
        ...
        <div class="w-full h-full bg-black flex flex-col">
            <div class="flex items-center justify-between p-4 bg-gray-900 text-white">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button data-action="resetSurfaceView" class="px-3 py-1 bg-gray-800 text-white rounded text-sm border border-gray-600 hover:bg-gray-700 transition-colors">
                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                        Reset
                    </button>
                </div>
            ...
            <div class="flex-1 p-4 flex items-center justify-center">
                <div id="surface-3d-viewer" class="viewer-3d"></div>
            </div>
        </div>
    `;
        ...
        <div class="w-full h-full bg-black flex flex-col">
            <div class="flex items-center justify-between p-4 bg-gray-900 text-white">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button data-action="resetPharmacophoreView" class="px-3 py-1 bg-gray-800 text-white rounded text-sm border border-gray-600 hover:bg-gray-700 transition-colors">
                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                        Reset
                    </button>
                </div>
            ...
            <div class="flex-1 p-4 flex items-center justify-center">
                <div id="pharmacophore-3d-viewer" class="viewer-3d"></div>
            </div>
        </div>
    `;
        ...
        <div class="w-full h-full bg-black flex flex-col">
            <div class="flex items-center justify-between p-4 bg-gray-900 text-white">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button data-action="resetScaffoldView" class="px-3 py-1 bg-gray-800 text-white rounded text-sm border border-gray-600 hover:bg-gray-700 transition-colors">
                        <i data-lucide="refresh-cw" class="w-3 h-3 inline mr-1"></i>
                        Reset
                    </button>
                </div>
            ...
            <div class="flex-1 p-4 flex items-center justify-center">
                <div id="scaffold-3d-viewer" class="viewer-3d"></div>
            </div>
        </div>
    `;
...
// Phase 5: register the four reset-view actions so the
// data-action="resetXView" buttons inside dynamically-built viewer HTML
// can be dispatched without inline `onclick=` handlers.
if (window.NuGenUtils && typeof window.NuGenUtils.registerAction === "function") {
  window.NuGenUtils.registerAction("reset3DView", reset3DView);
  window.NuGenUtils.registerAction("resetSurfaceView", resetSurfaceView);

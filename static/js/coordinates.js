/**
 * coordinates.js — page module for "/coordinates".
 *
 * Phase-5 mechanical extraction of the inline <script> that previously
 * lived in templates/coordinates.html. Logic preserved verbatim except that
...
(function () {
  "use strict";
  if (window.location.pathname !== "/coordinates") return;
        ...
        viewerDiv.innerHTML = `
            <div class="w-full h-full">
                ...
                <div class="bg-black border border-gray-200 rounded-lg p-1 mb-4">
                    <div id="coord-3d-viewer" class="viewer-3d-md"></div>
                </div>

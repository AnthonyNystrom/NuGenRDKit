...
class TestFingerprints:
    def test_morgan_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/morgan", json={"smiles": "CCO", "radius": 2, "n_bits": 1024}
        )
    ...
    def test_rdkit_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/rdkit", json={"smiles": "CCO", "fp_size": 2048}
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_maccs_fingerprint(self, client):
        ...
        response = client.post("/api/v1/fingerprints/maccs", json={"smiles": "CCO"})
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
        assert "fingerprint" in data
    ...
    def test_avalon_fingerprint(self, client):
        ...
        response = client.post("/api/v1/fingerprints/avalon", json={"smiles": "CCO", "n_bits": 512})
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
        assert "fingerprint" in data
    ...
    def test_atom_pairs_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/atom_pairs", json={"smiles": "CCO", "n_bits": 1024}
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_topological_torsions_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/topological_torsions", json={"smiles": "CCCC", "n_bits": 2048}
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_pattern_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/pattern", json={"smiles": "CCO", "fp_size": 1024}
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_layered_fingerprint(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/layered", json={"smiles": "CCO", "fp_size": 1024}
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_compare_fingerprints(self, client):
        ...
        response = client.post(
            ...
            json={"smiles1": "CCO", "smiles2": "CCC", "fp_type": "morgan", "radius": 2},
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
        ...
        for _sim_type, sim_value in similarities.items():
    ...
    def test_compare_identical_molecules(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/compare",
            json={"smiles1": "CCO", "smiles2": "CCO", "fp_type": "morgan"},
        )
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data["success"]
    ...
    def test_invalid_smiles(self, client):
        ...
        response = client.post("/api/v1/fingerprints/morgan", json={"smiles": "invalid_smiles"})
    ...
    def test_missing_smiles(self, client):
        ...
        response = client.post("/api/v1/fingerprints/morgan", json={})
        assert response.status_code == 400
        data = json.loads(response.data)
        assert not data["success"]
    ...
    def test_unsupported_fingerprint_type(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/compare",
            json={"smiles1": "CCO", "smiles2": "CCC", "fp_type": "unsupported_type"},
        )
        assert response.status_code == 400
        data = json.loads(response.data)
        assert not data["success"]

...
class TestFileUploads:
    ...
    def test_bulk_similarity_file_upload(self, client):
        ...
        response = client.post(
            "/api/v1/similarity/bulk_similarity_file", data=data, content_type="multipart/form-data"
        )
    ...
    def test_batch_descriptors_file(self, client):
        ...
        response = client.post(
            "/api/v1/descriptors/batch_file", data=data, content_type="multipart/form-data"
        )
    ...
    def test_batch_fingerprints_file(self, client):
        ...
        response = client.post(
            "/api/v1/fingerprints/batch_file", data=data, content_type="multipart/form-data"
        )
    ...
    def test_reaction_process_file(self, client):
        ...
        response = client.post(
            "/api/v1/reactions/process_file", data=data, content_type="multipart/form-data"
        )
    ...
    def test_diverse_subset_file(self, client):
        ...
        response = client.post(
            "/api/v1/similarity/diverse_subset_file", data=data, content_type="multipart/form-data"
        )
    ...
    def test_missing_file(self, client):
        ...
        data = {"query_smiles": "CCO", "fp_type": "morgan"}
